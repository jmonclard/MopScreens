...
function setup() {
  ...
  $sql = "CREATE TABLE IF NOT EXISTS `resultscreen` (
      ...
      `panel1displaynomprenom` tinyint(1) NOT NULL DEFAULT '0',
      ...
      `panel2displaynomprenom` tinyint(1) NOT NULL DEFAULT '0',
      ...
      `panel3displaynomprenom` tinyint(1) NOT NULL DEFAULT '0',
      ...
      `panel4displaynomprenom` tinyint(1) NOT NULL DEFAULT '0',
