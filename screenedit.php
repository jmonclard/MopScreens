...
<?php
    ...
    if (($rcid>0) && ($sid>0))
    {
        ...
        if (mysql_num_rows($res) > 0)
        {
            ...
            $str=NumericIntList("fullscrolledlines",2,20,$fullscrolledlines);
            ...
            $str=NumericIntList("leftscrolledlines",2,20,$leftscrolledlines);
            print "<td>Scrolled lines</td>\n";
            print "<td>$str</td>\n";
            print "</tr>\n";
            ...
            $str=NumericIntList("rightscrolledlines",2,20,$rightscrolledlines);
            print "<td>Scrolled lines</td>\n";
            print "<td>$str</td>\n";
            print "</tr>\n";
