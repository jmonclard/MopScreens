...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="styles/co2015-10-30i.css" />
...
?>
        ...
        function ConvertToNiceHtmlTableRow(panelIndex, identifiant, startline)
        {
            ...
            if (length > 0)
            {
                ...
                {
                    r += '<tr>\r\n';
                    r += '<th class="entete_relais" rowspan="2">&nbsp;</th>\r\n';
                    r += '<th class="entete_relais" rowspan="2">&nbsp;</th>\r\n';
                    r += '<th class="entete_relais" colspan="4">Relayeur 1</th>\r\n';
		    
                    r += '<th class="entete_relais" colspan="2" rowspan="2">Après R1</th>\r\n';
                    if(line[5] > 1)
                    {
                        r += '<th class="entete_relais" colspan="4">Relayeur 2</th>\r\n';
                        r += '<th class="entete_relais" colspan="2" rowspan="2">Après R2</th>\r\n';
                    }
                    if(line[5] > 2)
                    {
                        r += '<th class="entete_relais" colspan="4">Relayeur 3</th>\r\n';
                        r += '<th class="entete_relais" colspan="2" rowspan="2">Après R3</th>\r\n';
                    }
                    r += '</tr>\r\n';
		    r += '<tr>\r\n';
		    r += '<th class="entete_relais_radio">Radio1</th>\r\n';
		    r += '<th class="entete_relais_radio">Radio2</th>\r\n';
		    r += '<th class="entete_relais_radio">Radio3</th>\r\n';
		    r += '<th class="entete_relais_radio">Finish</th>\r\n';
		    if(line[5] > 1)
		    {
			r += '<th class="entete_relais_radio">Radio1</th>\r\n';
			r += '<th class="entete_relais_radio">Radio2</th>\r\n';
			...
			{
				r += '<tr class="' + cl + nf + '">\r\n';
				r += '<td rowspan="2" class="'+ prefix_class + '0' +'">' + line[6] + '</td>\r\n';
				r += '<td rowspan="2" class="'+ prefix_class + '1' +'">' + line[7] + '</td>\r\n';
				r += '<td colspan="6" class="relay_tm_name">' + line[26] + ((line[12].length) ? ' (' + line[12]+ ')' : '') + '</td>\r\n';
				if(line[5] > 1)
					r += '<td colspan="6" class="relay_tm_name">' + line[27] + ((line[18].length) ? ' (' + line[18]+ ')' : '') + '</td>\r\n';
				if(line[5] > 2)
					r += '<td colspan="6" class="relay_tm_name">' + line[28] + ((line[24].length) ? ' (' + line[24]+ ')' : '') + '</td>\r\n';
				r += '</tr>\r\n';
			}
                        r += '<tr class="' + cl + nf + '">\r\n';
                        for(var e in line)
